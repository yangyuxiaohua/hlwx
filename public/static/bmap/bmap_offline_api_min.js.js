...
(function () {
    ...
    z.ZU = z.apiLoad ||
        function () {
            z.version && z.version >= 1.5 && oa(z.qc + "?qt=verify&ak=" + pa,
                function (a) {
                    if (a && a.error !== 0) {
    ...
    x.object.extend(I, {
                    ...
                    e.EC == q && (e.EC = o, setTimeout(function () {
                            ...
                            if (a.length > 0) {
                                for (let i = 0; i < a.length; i++) {
                                    let mf = './static/bmap/modules/' + a[i] + '.js';
                                    oa(mf);
        ...
        nK: function (a) {
            if (a && this.tL()[a])
                for (var a = this.tL()[a], b = 0; b < a.length; b++) this.nK(a[b]),
        ...
        ib: function (a) {
            this.Pd.vl[a] || (this.Pd.vl[a] = {},
                this.Pd.vl[a].Bd = this.Fj.rG, this.Pd.vl[a].Tu = []);
            return this.Pd.vl[a]
        },
        remove: function (a) {
            delete this.ib(a)
        ...
        xV: function (a, b) {
            for (var c = this.Pd.Vv,
                    d = o,
                    e = 0,
                    f = c.length; e < f; e++) "" == c[e].ME && (c[e].VM == a ? c[e].ME = b : d = q);
            d && this.ZK()
        },
        ZK: function () {
            for (var a = this.Pd.Vv,
                    b = 0,
                    c = a.length; b < c; b++) this.CZ(a[b].VM, a[b].ME);
            this.Pd.Vv.length = 0
        }
    });
    ...
    function gb(a, b) {
        a && (this.Mb = a, this.ba = "spot" + gb.ba++, b = b || {},
            this.Sg = b.text || "", this.Bv = b.offsets ? b.offsets.slice(0) : [5, 5, 5, 5], this.wJ = b.userData || p, this.Qh = b.minZoom || p, this.Ef = b.maxZoom || p)
    }
    gb.ba = 0;
    ...
    function rc(a, b, c, d) {
        a && (this.Gv = {},
            this.eL = d ? !!d : q, this.Uc = [], this.B_ = a instanceof qc ? a : p, this.JI = b === j ? o : !!(b.indexOf("%") + 1), this.Zj = isNaN(parseFloat(b)) ? 1 : this.JI ? parseFloat(b) / 100 : parseFloat(b), this.KI = !!(c.indexOf("%") + 1), this.repeat = c != j ? this.KI ? parseFloat(c) / 100 : parseFloat(c) : 0)
    };
    ...
    function yc(a, b) {
        ...
        xc() && (a === j && ba(Error("\u6ca1\u6709\u4f20\u5165points\u6570\u636e")), "[object Array]" !== Object.prototype.toString.call(a) && ba(Error("points\u6570\u636e\u4e0d\u662f\u6570\u7ec4")), b = b || {},
            ...
            this.jB = [], this.oe = [], I.load("pointcollection",
                function () {
                    for (var a = 0,
                            b; b = c.jB[a]; a++) c[b.method].apply(c, b.arguments);
    ...
    x.extend(Fc.prototype, {
        ...
        q_: function (a, b, c, d) {
            ...
            k && k.Ib ? (ub(k.Ib, b), d && (d = new R(a[0], a[1]), f = this.map.C.xe ? this.map.C.xe.style : "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, Ic(k, d)), k.loaded ? this.xf() : Jc(k,
                function () {
                    e.xf()
                })) : (k = this.dj[g]) && k.Ib ? (c.Rb.insertBefore(k.Ib, c.Rb.lastChild), this.ug[g] = k, ub(k.Ib, b), d && (d = new R(a[0], a[1]), f = this.map.C.xe ? this.map.C.xe.style : "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, Ic(k, d)), k.loaded ? this.xf() : Jc(k,
                function () {
                    e.xf()
                })) : (k = i * Math.pow(2, f.wm() - a[2]), new H(a[0] * k, a[1] * k), d = new R(a[0], a[1]), f = this.map.C.xe ? this.map.C.xe.style : "normal", d = c.getTilesUrl(d, a[2], f), k = new Kc(this, d, b, a, c), Jc(k,
                function () {
                    e.xf()
                }), k.bo(), this.ug[g] = k)
        },
        ...
        Vt: function (a) {
            ...
            if (!this.map.Wb() && (a ? this.map.C.y_ = a : a = this.map.C.y_, a))
                for (var c = p,
                        c = "2" == z.Sy ? [z.url.proto + z.url.domain.main_domain_cdn.other[0] + "/"] : [z.url.proto + z.url.domain.main_domain_cdn.baidu[0] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[1] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[2] + "/"], d = 0, e; e = this.Nm[d]; d++)
                    if (e.l_ == o) {
                        b.k.$b = 18;
    ...
    x.extend(bc.prototype, {
        ca: function () {
            ...
            b.addEventListener("iid_changed",
                function () {
                    c.Pg(bc.dl + "qt=idata&iid=" + b.tA + "&fn=",
                        function (b) {
    ...
    x.extend(ae, {
        ...
        AL: function (a, b, c, d, e) {
            ...
            return (ae.Iu + "?qt=pr3d&fovy=75&quality=80&panoid={panoId}&heading={panoHeading}&pitch={panoPitch}&width={width}&height={height}").replace(/\{(.*?)\}/g,
                function (a, b) {
                    return f[b]
                })
        }
            ...
            if (!(Ae && 0 !== a.touches.length)) {
                ...
                if (b.Yk) d = b.scale * b.vp,
                    ...
                    if (b.oh) {
                        ...
                        if (Ae)
                            if (b.IK && b.options.zoom) clearTimeout(b.IK),
                                b.IK = p,
